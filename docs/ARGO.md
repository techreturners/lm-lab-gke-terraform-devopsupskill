...
You'll see some pods listed as running when ready to go.
...
### Step 5 - Creating an application via UI

Now the exciting part - lets get that container image deployed.